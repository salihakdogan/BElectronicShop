<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="urundetay.aspx.cs" Inherits="BElectronicShop.urundetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div id="mainBody">
	   <div class="container">
           <div class="row">
	<%BElectronicShop.UrunCRUD urundetaycrud = new BElectronicShop.UrunCRUD();
      BElectronicShop.Urun urunbilgi = new BElectronicShop.Urun();
      urunbilgi = urundetaycrud.urundetaygoster(Request.QueryString[0]);%>		   

	<div class="span9"">
    <ul class="breadcrumb">
    <li><a href="index.html">Anasayfa</a> <span class="divider">/</span></li>
    <li><a href="products.html">Son eklenenler</a> <span class="divider">/</span></li>
    <li class="active"><%=urunbilgi.Urunadi %></li>
    </ul>
	...
	<div class="row">	  
            ...
            <a href="<%=urunbilgi.Uresim %>" title="<%=urunbilgi.Urunadi %>">
				<img src="<%=urunbilgi.Uresim %>" style="width:100%" alt="<%=urunbilgi.Urunadi %>"/>
            </a>
			...
			<div class="span6">
				<h3><%=urunbilgi.Urunadi %> </h3>
				<small>- (14MP, 18x Optical Zoom) 3-inch LCD</small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span><%=urunbilgi.Ufiyat %> TL</span></label>
					<div class="controls">
					<input type="number" class="span1" placeholder="Adet"/>
					  <a class="btn btn-large btn-primary pull-right" href="sepet.aspx?prmurundetay=<%=Request.QueryString[0] %>">Satın al <i class="icon-shopping-cart"></i></a> 
				...
				<hr class="soft"/>
				<h4>Son <%=urunbilgi.Ustokadet %> ürün</h4>
